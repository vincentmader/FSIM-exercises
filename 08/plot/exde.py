...
print(Topt)
print(Nopt)
print("Tree(1e10)=", np.exp(loglin(np.log(1e10), Topt[0], Topt[1]))/60/60/24/365)
print("Nsqr(1e10)=", np.exp(loglin(np.log(1e10), Nopt[0], Nopt[1]))/60/60/24/365)
plt.plot(N, tTree, '.', label="Tree")
plt.plot(N, tNsqr, '.', label="exact")

print(np.exp(loglin(1e10, Topt[0], Topt[1]))
