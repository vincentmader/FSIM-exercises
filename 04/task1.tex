...
\\
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=.8\textwidth]{./figures/task1_1_orbit_lf.pdf}
...
\\
    ...
    same spot each time after circling the star, which is due to the discrete
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=.8\textwidth]{./figures/task1_1_orbit_lf_100.pdf}
...
\\
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=.8\textwidth]{./figures/task1_1_orbit_rk2.pdf}
        \caption{2nd order Runge-Kutta algorithm}
    \end{figure} \ \\ 
    \begin{figure}[h!]
        \centering
        \includegraphics[width=.8\textwidth]{./figures/task1_1_orbit_rk4.pdf}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=.8\textwidth]{./figures/task1_1_energies_lf_test.pdf}
        \caption{total energy balance as well as relative energy error plotted 
            vs. time for leapfrog solver}
    \end{figure} \ \\ 
    \begin{figure}[h!]
        \centering
        \includegraphics[width=.8\textwidth]{./figures/task1_1_energies_rk2.pdf}
        \caption{total energy balance as well as relative energy error plotted 
            vs. time for second-order Runge-Kutta}
    \end{figure} \ \\ 
    \begin{figure}[h!]
        \centering
        \includegraphics[width=.8\textwidth]{./figures/task1_1_energies_rk4.pdf}
        \caption{total energy balance as well as relative energy error plotted 
